...
const Header = () => {
    ...
    return (
        <div className='bg-blue-950  text-gray-200'>
            <div className='header-container flex flex-wrap justify-between items-center gap-4 p-4 sm:p-5 mx-auto'>
                <div className="header-logo">
                    <Link href="/">
                        <h3 className='text-2xl sm:text-3xl font-bold'>Skill<span className='text-yellow-500'>Sphere</span></h3>
                    </Link>

                </div>
                <div className='right-part gap-2 sm:gap-4 flex flex-wrap items-center'>

                    {isPending ? <span className="loading loading-spinner loading-xl"></span> : session ? <span className='gap-2 sm:gap-4 flex flex-wrap items-center'> <NavLink href="/">Home</NavLink>
                    ...
                    </span> : <span className='logout-state gap-2 sm:gap-4 flex flex-wrap items-center'>
